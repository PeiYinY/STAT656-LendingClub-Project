...
LCDataTB <- select(LCDataTB, -c(collections_12_mths_ex_med,chargeoff_within_12_mths))
...
LCDataTB <- select(LCDataTB, -c(funded_amnt, funded_amnt_inv, total_pymnt, 
                                ...
                                earliest_cr_line))
#Pei <- c(collection_recovery_fee, recoveries,
         #earliest_cr_line, funded_amnt_inv, installment,
...
```{r}
LCDataTB %>% select(delinq_2yrs,inq_last_6mths,pub_rec,
                    total_acc,chargeoff_within_12_mths,
